...
DB_PATH="${1:-${DB_PATH:-$HOME/.ros/go2_rtabmap_sim.db}}"
OUTPUT_NAME="${2:-${OUTPUT_NAME:-go2_rtabmap_$(date +%Y%m%d_%H%M%S)}}"
OUTPUT_DIR_INPUT="${OUTPUT_DIR:-$ROOT_DIR/cloud_map}"
...
find_rtabmap_export() {
  ...
  for candidate in \
    ...
    "/home/wzy/ROS2/backup/third_party/rtabmap-0.23.4/install_x86/bin/rtabmap-export" \
