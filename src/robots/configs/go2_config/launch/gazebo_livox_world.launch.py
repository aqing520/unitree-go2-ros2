...
def generate_launch_description():
    ...
    # Use robot_Livox.xacro so Livox 3D LiDAR is loaded by default.
    default_model_path = os.path.join(descr_pkg_share, "xacro/robot_Livox.xacro")
    # Use outdoor world by default; can still be overridden via world:=...
